...
void Drawing::CreateFonts()
{
	...
	LastFontName = "hooge 05_55 Cyr2"; //yes 
	csgo.m_surface()->SetFontGlyphSet(F::ESPInfo = csgo.m_surface()->CreateFont_(), sxor( "hooge 05_55 Cyr2" ), 9, 100, NULL, NULL, FONTFLAG_OUTLINE );
	LastFontName = "Lucida Console"; //yes
